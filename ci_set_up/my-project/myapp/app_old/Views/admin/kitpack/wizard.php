...
<?php
    ...
    */
    ...
    $tab_content_select_operations = $this->load->view("admin/kitpack/tab_content_select_operations", $data, true);
    
    $tab_content_configure_set = $this->load->view("admin/kitpack/tab_content_configure_set", $data, true);
    
    $tab_content_quantity_planning = $this->load->view("admin/kitpack/tab_content_quantity_planning", $data, true);
    
    $tab_content_set_approval = $this->load->view("admin/kitpack/tab_content_set_approval", $data, true);
    ...
    $kitpack_standards = $this->load->view("admin/kitpack/kitpack_standards", $data, true);
...
<div id="kitpack-wizard" class="row">
	<div class="col-xs-12">
        <form id="form_set" name="form_set" action="<?php echo base_url("admin/kitpack/".$action); ?>" method="POST" class="form form-horizontal set-form">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-5">
                    <div class="row">
                        <div class="col-xs-4">
                            <button id="btn_cancel" name="btn_cancel" type="button" value="cancel" class="btn btn-default btn-block text-primary custom_text_umbruch"><?php echo lang("btn_cancel"); ?></button>
                        </div>
	                    <div class="col-xs-4">
                        ...
                        <div class="col-xs-4">
                            <?php
                                ...
                                {
                                    echo '<button id="btn_next" mode="'.$ruleset.'" do_approval ="'.$do_approval.'" name="btn_next" type="button" value="'.E_SET_STATUS::WAITING_FOR_APPROVAL.'" class="btn btn-default btn-success btn-block custom_text_umbruch" style="color:white;">'.lang("btn_continue").'</button>';
                                }
                                else
                                {
                                    echo '<button id="btn_next" mode="standard" name="btn_next" type="button" value="'.E_SET_STATUS::WAITING_FOR_APPROVAL.'" class="btn btn-default btn-success btn-block custom_text_umbruch" style="color:white;">'.lang("btn_continue").'</button>';
                                }
                            ?>
                        </div>
                    </div>
