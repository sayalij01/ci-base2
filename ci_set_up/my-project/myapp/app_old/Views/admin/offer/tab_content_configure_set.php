<?php
    ...
    $counter = 1;
    $currency_matrix = $data["currencyMatrix"];
    //die("<pre>".print_r($currency_matrix,true)."</pre>");
	...
	$adv_search_panel->setPanelTitle($this->load->view("admin/components/component_filter_for_offer", $data["searchdata"], true));
	...
	$drag_drop_configuration_tree = $this->load->view("admin/offer/drag_drop_configuration_tree", $data, true);

    $calculation_form = $this->load->view("admin/offer/calculation",$data,true);
    ...
    $visible = "";
    if(!$data["permissions"]["show_calculation_view"])
    {
...
<div class="panel-container">
    ...
    <div class="panel-left" id="offer-frame-side-panel-left" >
        <div class="row " >
            <div class="col-sm-12 offer-frame-sidebar">
                <div class="row">
                    ...
                    {
                        echo '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-primary">';
                    }
                    ?>
                    <div style="margin:10px 0 0 38px;font-size:20px;font-weight:bold;display:none;"><?php echo lang("set_name"); ?>:&nbsp;<span id="set_name_display"></span></div>
                    ...
                    ?>
                    <div class="tab-content no-padding-left col-md-12" >
                        <div id="search_panel">
                            <?php echo $search_panel->generateHTML(); ?>
                            <div id="adv_search_panel" class="panel panel-default nopadding" style="display:none;">
                                <?php echo $this->load->view("admin/components/component_filter_for_offer", $data["searchdata"], true).$adv_search_panel_state->generateHTML(); ?>
                            </div>
                        </div>

                        <div id="componnents_tables_scroll_container" style="overflow:auto;">
                            <div id="step_panels" class="tab-pane" style="height: 100%;overflow:auto;"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-primary" style="display:none;">
        ...
        <div class="btn-arrow text-right">
            <a id="btn-offer-frame-side-panel-left" style="padding-right: 33px; position: absolute;"><i class="fa fa-chevron-circle-left fa-2x" aria-hidden="true"></i></a>
        </div>
    </div>
    </div>
    ...
    <div class="panel-center">
        <div class="row">
            <div class="col-md-12 offer-frame-sidebar-no-height">
                ...
                <div class ="row" style="padding: 20px" id="kitpack_order" class="<?php echo $configuration_box_cols; ?>" >
    ...
    <div class="splitter2" style="<?php echo $visible;?>">
    </div>
    <div class="panel-right" id="offer-frame-side-panel-right" style="min-width:315px;<?php echo $visible;?>">
        <a id="btn-offer-frame-side-panel-right" style="padding-right: 33px; position: absolute; height: 700px; display: flex; align-items: center; margin-left: -9px;"><i style="z-index:900;" class="fa fa-chevron-circle-right fa-2x" aria-hidden="true"></i></a>
        <?php echo $calculation_form; ?>
    </div>
