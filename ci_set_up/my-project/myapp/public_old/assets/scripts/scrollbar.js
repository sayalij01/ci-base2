  ...
  setTimeout(function () {
    if ($(".scrollbar-container")[0]) {
      $('.scrollbar-container').each(function () {
        const ps = new perfect_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"]($(this)[0], {
          wheelSpeed: 2,
          wheelPropagation: false,
          minScrollbarLength: 20
        });
      });
      const ps = new perfect_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"]('.scrollbar-sidebar', {
        wheelSpeed: 2,
        wheelPropagation: false,
        minScrollbarLength: 20
      });
