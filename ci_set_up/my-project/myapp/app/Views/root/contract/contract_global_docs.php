<?php
	...
	//.:::::::::::::::::::::::::::::::::::::................
	// custom filters
	$btn_reset	    = new HTML_Button("btn_filter_assignments_remove", "filter_assignments_global_documents", lang("show_all"), E_COLOR::STANDARD, E_SIZES::STANDARD, "", "left", E_VISIBLE::YES, E_ENABLED::YES);
	$btn_reset->setValue("reset");
	
	$btn_available_bw	    = new HTML_Button("btn_filter_assignments_available_bw", "filter_assignments_global_documents", lang("available_bw"), E_COLOR::STANDARD, E_SIZES::STANDARD, "", "left", E_VISIBLE::YES, E_ENABLED::YES);
	$btn_available_bw->setValue("available_bw");
	
	$btn_available_sn	    = new HTML_Button("btn_filter_assignments_available_sn", "filter_assignments_global_documents", lang("available_sn"), E_COLOR::STANDARD, E_SIZES::STANDARD, "", "left", E_VISIBLE::YES, E_ENABLED::YES);
	$btn_available_sn->setValue("available_sn");
	
	$btn_billing_relevant    = new HTML_Button("btn_filter_assignments_billing_relevant", "filter_assignments_global_documents", lang("billing_relevant"), E_COLOR::STANDARD, E_SIZES::STANDARD, "", "left", E_VISIBLE::YES, E_ENABLED::YES);
	$btn_billing_relevant->setValue("billing_relevant");
	
	$btn_mandatory_to_complete	    = new HTML_Button("btn_filter_assignments_mandatory_to_complete", "filter_assignments_global_documents", lang("mandatory_to_complete"), E_COLOR::STANDARD, E_SIZES::STANDARD, "", "left", E_VISIBLE::YES, E_ENABLED::YES);
	$btn_mandatory_to_complete->setValue("mandatory_to_complete");
	
	$btn_to_be_signed_by_insured_person	    = new HTML_Button("btn_filter_assignments_to_be_signed_by_insured_person", "filter_assignments_global_documents", lang("to_be_signed_by_insured_person"), E_COLOR::STANDARD, E_SIZES::STANDARD, "", "left", E_VISIBLE::YES, E_ENABLED::YES);
	$btn_to_be_signed_by_insured_person->setValue("to_be_signed_by_insured_person");
	
	$btngrp_filter_assigned_documents = new HTML_ButtonGroup("btngrp_filter_assignments_global_documents");
	...
	$fi_filter_assigned_documents = new HTML_FormItem("", "fi_filter_assignments_global_documents", "btngrp_filter_assignments_global_documents", array(), E_REQUIRED::NO,array(2,5));
	...
	$i_document_types = new HTML_Select("i_document_type", "document_type", $options );
	...
	$fi_upload_global_document = new HTML_FormItem(lang("upload_document"), "fi_upload_global_document", "upload_document[]");
	$fi_upload_global_document->addComponent('<input id="i_upload_global_document" name="upload_document[]" class="btn btn-block btn-default" type="file">' );
	...
	$hidden_revision           = new HTML_Input("i_contract_revision_docs", "contract_revision_docs", E_INPUTTYPE::HIDDEN, lang("contract_revision"), $contract->contract_revision);
	...
	->addFormItem('<input id="i_upload_global_document" name="upload[]" class="btn btn-block btn-default" type="file">')
	->addFormItem($hidden_contract_id)
	->addFormItem($hidden_revision)
	->addFormItem($hidden_contract_save);
	
	// ..:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::..
	// ..:: assigned/uploaded documents 
	$tbl = new HTML_Datatable("tbl_contract_global_documents", $contract->get_table_columns_documents(), array());	// $contract->assigned_documents
