...
class App extends BaseConfig
{
    ...
    public $logThreshold = 4; // Set to 4 for full debugging mode
    public $toolbar = true; // Enable the Debug Toolbar
    ...
    public $default_language_code = 'DE';



    public $site_name = 'CI_BASE';
    public $site_title = 'CI_BASE_Version_2';
    public $site_description = 'CI_BASE_Version_2';
    public $site_keywords = 'CI_BASE_Version_2';
    public $site_author = "www.codenground.de";
    public $site_logo 			= PATH_IMAGES.'logos/site-logo_60x60.png';	// should match navbar height
    public $site_copyright		= '&copy; 2023 CI_BASE';

    // ..:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::..
// ..:: Toggle functions
// ..:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::..

    public $enable_debug_files = 0;
    public $enable_console_log = 1;
    ...
    public $fluid_header			= 1;
    public $fluid_layout			= 1;
    public $fluid_footer			= 1;

    public $navbar_inverse		= 0;
    public $navbar_fixed			= 1;
    public $navbar_location		= "top";		// <top|bottom>

    public $footer_inverse		= 0;
    public $footer_fixed			= 1;
    public $footer_location		= "bottom"; 	// <top|bottom>
    public $footer_console		= 0;

    public $sidebar_inverse		= 0;
    public $sidebar_fixed		= 1;
    public $sidebar_location		= "left"; 		// <left|right>   !! @todo currently only right works
     ...
     */
    public $cdn						=  FCPATH."resources/cdn/";		// URL to the third party javascript libs & plugins
    ...
    // public $import_content_folder    = $config['upload_folder']."content_importer/";
    // public $static_files_folder      = "resources/files/";
    // public $idoc_target_directory    = $config['upload_folder']."idocs/";
    // public $csv_target_directory     = $config['upload_folder']."csv/";

    public $log_path ='app/debug/';
